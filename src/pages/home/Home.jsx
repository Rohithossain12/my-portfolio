        ...
        <div className="flex flex-col md:flex-row items-center justify-between text-center md:text-left p-10 space-y-6 md:space-y-0">
          <div className="md:w-1/2">
            ...
            <div className="flex space-x-6 justify-center md:justify-start mt-6">
              <a href="https://github.com/Rohithossain12" className="text-2xl sm:text-3xl md:text-4xl hover:text-white">
                <FaGithub />
              </a>
              <a href="https://www.linkedin.com/in/rohit-hossain-4b21281b9" className="text-2xl sm:text-3xl md:text-4xl hover:text-white">
                <FaLinkedin />
              </a>
              <a href="https://www.facebook.com/rafid.islam.96199" className="text-2xl sm:text-3xl md:text-4xl hover:text-white">
                <FaFacebook />
              </a>
              <a href="mailto:rafidislamrohit576@gmail.com" className="text-2xl sm:text-3xl md:text-4xl hover:text-white">
                <FaEnvelope />
              </a>
              <a href="https://x.com/RafidRohit41291" className="text-2xl sm:text-3xl md:text-4xl hover:text-white">
                <FaTwitter />
              </a>
            </div>
            <div className="mt-6">
